<template>
    <div class="container">
        <div class="tab-pane fade show active">
            <div class="row">
                <div class="col-md-12">
                    <h3>Enter the details of the invoice below</h3>
                    <form @submit.prevent="onSubmit">
                        ...
                        <div class="form-group">
                            ...
                            <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#transactionModal"> + </button>
...
export default {
    ...
    data() {
        return {
            ...
            nextTxnId: 1,       // next index for the array
            loading: "",
            status: ""
        };
    },
    ...
    methods: {
        saveTransaction() {
            ...
            if(name.length != 0 && price > 0) {
                ...
                // Clear new transaction input form
        ...
        onSubmit() {
            ...
            this.loading = "Creating Invioce, Please wait";

            // post to server
            axios.post("http://localhost:8000/invoice", formData).then(res => {
                this.loading = "";
